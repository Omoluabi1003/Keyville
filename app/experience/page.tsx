    ...
    <div className="experience-page">
      <section className="experience-hero">
        <div className="hero-copy">
          ...
          <p className="lead">
            You can try a quest without making an account. Use your keyboard or tap the buttons. Every control works with
            screen readers.
          </p>
      ...
      <Section title="One clear move per screen" subtitle="One main choice at a time with read aloud built in." id="single-step">
        <div className="single-step">
          <div className="single-step__copy">
            <p>
              You see one main choice at a time. Read aloud icons and scaffold tools stay on so you never feel stuck.
              Buttons and cards sit in the same spot on every screen for quick muscle memory.
            </p>
          ...
          <div className="quest-card__body">
            ...
            <div className="quest-grid" role="list">
              {questCards.map((quest) => (
                <div className="quest" role="listitem" key={quest.title}>
        ...
        <div className="scaffold-grid">
          <div className="card scaffold-card">
            ...
            <div className="pill-row" role="list">
              {wordBank.map((word) => (
                <button key={word} className="pill" role="listitem" type="button">
                  {word}
                </button>
              ))}
            </div>
          ...
          <div className="card scaffold-card">
            ...
            <div className="pill-column" role="list">
              {sentenceStarters.map((starter) => (
                <button key={starter} className="pill pill--wide" role="listitem" type="button">
                  {starter}
                </button>
              ))}
            </div>
      ...
      <Section title="Days practiced this week" subtitle="Practice streak with gentle glow." id="streak">
        <p className="small">
          Each time you finish a quest, a day on your streak bar will glow. If you miss a day, the bar resets and you get a
      ...
      <Section title="Read aloud everywhere" subtitle="Speaker icons stay near the text you need." id="read-aloud">
        <p className="small">
          Every main instruction and scaffold has a small speaker icon. Tap the icon on a computer or mobile PWA to hear the
          text read out loud.
        </p>
